...
module namespace filesize="filesize";
...
declare function filesize:get-file-header($url as xs:string?) {
    ...
    let $results := system:as-user((util:base64-decode("YWRtaW4=")),(util:base64-decode("a2hhdHJ1")), (process:execute(("curl", $opts, $input) , $options)))
    return
    $results
};

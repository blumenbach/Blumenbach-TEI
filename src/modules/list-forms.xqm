...
(:
: Module Name: list-forms
: Module Version: 
: Date: 
: License: GNU-LGPL
: 
: Module Overview: Functions for Listing Form Data
:)

(:~
 : Functions for Listing Form Data
 : 
 :)
 
module namespace list-forms="http://exist-db.org/xquery/list-forms";

...
(:
: Module Name: edit-tei
: Module Version: 
: Date: 
: License: GNU-LGPL
: 
: XQuery Specification : XQuery v3.0
: Module Overview: This is a prototype XForm generator
:)

(:~ This is a prototype XForm generator that uses BetterForm 
:)
...
<html   xmlns="http://www.w3.org/1999/xhtml"
   ...
   <head>
      <title>Edit Task</title>
       <link rel="stylesheet" type="text/css" href="../resources/css/bf.css"/>
       <link rel="stylesheet" type="text/css" href="../resources/css/demo.css"/>
       <link rel="stylesheet" type="text/css" href="../resources/css/timetracker.css"/>
       <link rel="stylesheet" type="text/css"
             href="../resources/css/InlineRoundBordersAlert.css"/>
    </head>
    <body class="tundra InlineRoundBordersAlert">
    	<div id="xforms">
            <div style="display:none">
                <xf:model>
                    <xf:instance id="i-task" src="../pages/task.xml"/>
                 ...
                 <xf:instance id="i-project"     src="../pages/project.xml"/>
                 <xf:instance id="i-worker"  	 src="../pages/worker.xml"/>
                 <xf:instance id="i-tasktype"  	 src="../pages/tasktype.xml"/>
                 <xf:instance id="i-controller"  src="../pages/controller.xml"/>

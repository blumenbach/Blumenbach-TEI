...
: Module Overview: Functions that support themes
:)

(:~ Functions that support themes
:)

module namespace theme="http://exist-db.org/xquery/theme";
...
declare function theme:get-default() {
    concat($config:themes, "/default")
};

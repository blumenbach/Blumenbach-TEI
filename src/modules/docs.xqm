...
: Module Overview: Processes Wiki style documentation from atoms
:)

(:~ This module processes Wiki style documentation from atoms that source from Markdown 
:)
...
declare function docs:content($node as node(), $model as map(*)) {
    element { node-name($node) } {
        ...
        return docs:process-content($atomContent/@type, $content, $model)
    }
};

...
(:
: Module Name: login-helper
: Module Version: 
: Date: 
: License: GNU-LGPL
: 
: Module Overview: Functions that assist authentication
:)

(:~
 : Functions that assist authentication
 : 
 :)
 
module namespace login-helper="http://exist-db.org/xquery/login-helper";

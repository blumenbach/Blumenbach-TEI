...
<style type="text/css">
a { color: black; border: none; text-decoration: none; } img { border: none; }
</style>
</head>
...
<xsl:apply-templates xmlns:xsl="http://www.w3.org/1999/XSL/Transform" select="@id"/>
<div>
<xsl:call-template xmlns:xsl="http://www.w3.org/1999/XSL/Transform" name="add-style-attribute"/>

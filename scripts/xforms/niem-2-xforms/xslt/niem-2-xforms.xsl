...
<xsl:template name="leaf-node">
   ...
   <xsl:choose>
      <xsl:when test="ends-with($leaf-name, 'Amount')
                            or ends-with($leaf-name, 'Count')
                            or ends-with($leaf-name, 'ID')
                            or ends-with($leaf-name, 'Measure')
                            or ends-with($leaf-name, 'Name')
                            or ends-with($leaf-name, 'Percent')
                            or ends-with($leaf-name, 'Year')
                            ">
         <xf:input>
